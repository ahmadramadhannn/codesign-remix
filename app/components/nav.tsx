...
export function Nav() {
  return (
    <nav className="grid fixed lg:place-content-end lg:static bottom-0 right-0 w-full border-t-4 border-black lg:border-none p-4 xl:p-0 bg-home-primary-blue z-[9999]">
